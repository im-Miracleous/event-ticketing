...
class Transaction extends Model {
    ...
    protected $fillable = ['id', 'total_amount', 'transaction_status', 'user_id', 'payment_id', 'event_id', 'promotion_id'];
    ...
    public function promotion() { return $this->belongsTo(Promotion::class, 'promotion_id'); }
