 ...
 *
 * Defines the sidebar navigation items for each user role.
 * This is used by the Sidebar component to dynamically render menus.
 *
 * Backed by database tables:
 *  - Admin:     users, events, event_category, transactions, payments, promotions, validation_logs, app_settings
 *  - Organizer: events, tickets_types, attendees, promotions, transactions
 *  - User:      events, tickets, wishlists, waiting_list
 */

import React from 'react';

export type UserRole = 'root' | 'admin' | 'organizer' | 'user';
...
export interface NavItem {
    ...
    /** If true, only visible when root-level access is active */
    rootOnly?: boolean;
}
...
/**
 * Admin sidebar links.
 * Covers: users, events, event_category, transactions, payments, promotions,
...
const navigationMap: Record<UserRole, NavItem[]> = {
    root: adminNavItems,
    admin: adminNavItems.filter(item => !item.rootOnly),
    organizer: organizerNavItems,
    user: userNavItems,
};

export function getNavItemsForRole(role: UserRole): NavItem[] {
    return navigationMap[role] ?? userNavItems;
}
