...
export default function EditEvent({ event, categories, organizers, existingTicketTypes }: { event: EventProps, categories: any[], organizers?: any[], existingTicketTypes?: any[] }) {
    const { currency } = usePage().props as any;
    const isOrganizer = !organizers;
    ...
    const [ticketTypes, setTicketTypes] = useState<TicketTypeRow[]>(
        (existingTicketTypes || []).map((tt: any) => ({
            id: tt.id,
            name: tt.name,
    ...
    const submit = (e: FormEvent) => {
        ...
        const routeName = isOrganizer ? 'organizer.events.update' : 'admin.events.update';

        // Sync ticket types into form data
