...
export default function AdminDashboard({ stats, recentActivities, upcomingEvents }: Props) {
    return (
        <DashboardLayout>
            ...
            <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-500 dark:text-slate-400 mt-1">High-level overview of platform health and activity.</p>
                    </div>
                </div>
            </div>
                ...
                <div className="rounded-2xl bg-white dark:bg-white/[0.03] border border-slate-200 dark:border-white/5 shadow-sm dark:shadow-none">
                    ...
                    <ul className="divide-y divide-slate-100 dark:divide-white/5">
                        {recentActivities.length > 0 ? recentActivities.map((activity) => (
                            ...
                            <li className="px-5 py-8 text-center text-sm text-slate-400 dark:text-slate-500">
