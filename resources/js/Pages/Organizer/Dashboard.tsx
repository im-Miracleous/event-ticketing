        ...
        <DashboardLayout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                <div className="bg-navy-900 border border-white/5 rounded-2xl p-6 shadow-sm flex items-center justify-between hover:border-primary-500/30 transition-all cursor-pointer">
                    <div>
                        ...
                        <h2 className="text-3xl font-black text-white">{stats.totalActiveEvents}</h2>
                    </div>
                ...
                <div className="bg-navy-900 border border-white/5 rounded-2xl p-6 shadow-sm flex items-center justify-between hover:border-blue-500/30 transition-all cursor-pointer">
                    <div>
                        ...
                        <h2 className="text-3xl font-black text-white">{stats.totalTicketsSold.toLocaleString('id-ID')}</h2>
                    </div>
                ...
                <div className="bg-navy-900 border border-white/5 rounded-2xl p-6 shadow-sm flex items-center justify-between hover:border-emerald-500/30 transition-all cursor-pointer">
                    <div>
                        ...
                        <h2 className="text-2xl font-black text-white">{formatCurrency(stats.totalRevenue)}</h2>
                    </div>
                    <div className="w-12 h-12 bg-emerald-900/50 rounded-xl flex items-center justify-center text-emerald-400 flex-shrink-0">
                ...
                <div className="bg-navy-900 border border-white/5 rounded-2xl p-6 shadow-sm flex items-center justify-between hover:border-purple-500/30 transition-all cursor-pointer">
                    <div>
                        <p className="text-sm font-medium text-slate-400 mb-1">Peserta Unik</p>
                        <h2 className="text-3xl font-black text-white">{stats.newAttendees.toLocaleString('id-ID')}</h2>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="col-span-1 lg:col-span-2 bg-navy-900 border border-white/5 rounded-2xl p-6">
                    <h3 className="text-lg font-bold text-white mb-6">Grafik Transaksi Penjualan (30 Hari)</h3>
                ...
                {/* Event Performance */}
                <div className="col-span-1 bg-navy-900 border border-white/5 rounded-2xl p-6">
                    <h3 className="text-lg font-bold text-white mb-6">Analisis Performa Event (Top 5)</h3>
                    <div className="h-72 w-full">
                        {charts.eventPerformance && charts.eventPerformance.length > 0 ? (
                            <ResponsiveContainer width="100%" height="100%">
                                <BarChart data={charts.eventPerformance} layout="vertical" margin={{ top: 5, right: 30, left: 20, bottom: 5 }}>
                                    ...
                                    <XAxis type="number" stroke="#94a3b8" tickFormatter={(val) => `Rp${val / 1000000}M`} />
            ...
            <div className="bg-navy-900 border border-white/5 rounded-2xl p-8 shadow-sm flex flex-col md:flex-row items-center justify-between relative overflow-hidden">
                <div className="absolute top-0 right-0 w-64 h-64 bg-primary-500/10 blur-[100px] pointer-events-none" />
                <div className="relative z-10 w-full md:w-2/3">
                    <h2 className="text-2xl font-bold text-white mb-2">Manajemen Event</h2>
                    <p className="text-slate-400">Pantau operasional setiap event secara detail, validasi tiket, dan kelola promosi Anda.</p>
                </div>
