        ...
        <OrganizerLayout header={`MANAJEMEN TIKET: ${event.title}`}>
            ...
            <div className="max-w-5xl mx-auto space-y-6 mt-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    {/* Add Ticket Form */}
                    <div className="bg-white border border-gray-200 shadow-sm rounded-xl overflow-hidden h-fit">
                        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
                            <h2 className="text-lg font-bold text-gray-800">Tambah Jenis Tiket</h2>
                        </div>
                        <form onSubmit={submit} className="p-6 space-y-4">
                            <div className="space-y-2">
                                <label className="block text-sm font-bold text-gray-700">Jenis Tiket</label>
                                <select 
                            ...
                            <div className="space-y-2">
                                <label className="block text-sm font-bold text-gray-700">Kuota / Jumlah Tiket</label>
                                <input 
                                    type="number" 
                                    className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-sm"
                                    ...
                                    ticketTypes.map((ticket) => (
                                        <div key={ticket.id} className="p-6 flex items-center justify-between hover:bg-gray-50 transition-colors">
                                            <div>
                                                ...
                                                <p className="text-sm font-medium text-gray-500">Kuota Total: {ticket.quota}</p>
                                            </div>
