                    ...
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="bg-slate-50 dark:bg-navy-950/50 border-b border-slate-200 dark:border-white/5 text-slate-500 dark:text-slate-400">
                                ...
                                <SortableHeader label="Peserta" column="attendee_name" currentSort={sort} currentDirection={direction} onSort={handleSort} className="py-4 px-6 text-xs font-bold uppercase tracking-wider" />
                                ...
                                <SortableHeader label="Tanggal Beli" column="issued_at" currentSort={sort} currentDirection={direction} onSort={handleSort} className="py-4 px-6 text-xs font-bold uppercase tracking-wider text-right" />
                            </tr>
                        </thead>
                        ...
                        <div className="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
                            <div>
                                <p className="text-sm text-slate-700 dark:text-slate-400">
                                    Daftar peserta <span className="font-bold text-slate-900 dark:text-white">{attendees.data.length}</span> dari <span className="font-bold text-slate-900 dark:text-white">{attendees.total}</span> data keseluruhan.
                                </p>
                            </div>
                            <div>
