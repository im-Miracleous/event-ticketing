    ...
    const sidebarContent = (
        <div className="flex flex-col h-full">
                        ...
                        <Link
                            ...
                            className={`flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-200 group ${
                                active
                                    ...
                                    : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-navy-900/5 hover:text-slate-900 dark:hover:text-white'
                            }`}
                        >
            ...
            <div className="px-3 py-4 border-t border-slate-200 dark:border-white/5">
                <div className="px-3 py-2 rounded-xl bg-slate-50 dark:bg-navy-900/[0.03] border border-slate-200 dark:border-white/5">
