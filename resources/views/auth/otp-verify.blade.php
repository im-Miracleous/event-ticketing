            ...
            <div class="flex gap-2 sm:gap-3 justify-between">
                @foreach(range(1, 6) as $i)
                    <input type="text" 
                           ...
                           inputmode="numeric"
                           data-index="{{ $i }}"
                           class="otp-digit-input w-full h-14 sm:h-16 text-center text-2xl font-black rounded-xl border border-white/10 focus:ring-2 focus:ring-primary-500 focus:border-primary-500/50 transition-all duration-300 bg-white/5 text-white placeholder-white/5 shadow-[inset_0_2px_4px_rgba(0,0,0,0.3)] backdrop-blur-md"
